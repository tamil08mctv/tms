...
from .views.public import (
    ...
    product_detail, categories_page, search_suggestions
)
...
from .views.superadmin import (
    ...
    manage_store_admins, create_store_admin, edit_store_admin, 
    toggle_store_admin, delete_store_admin, delete_store
)
...
urlpatterns = [
    ...
    # Variants – ONLY THIS PATH (with product_id – prevents 404 & keeps context)
    path('store-admin/products/<int:product_id>/variants/', manage_variants, name='manage_variants'),
    path('store-admin/products/<int:product_id>/variants/edit/<int:variant_id>/', edit_variant, name='edit_variant'),
    
    # Other store admin sections
    ...
    # Super Admin → Store Admins Management
